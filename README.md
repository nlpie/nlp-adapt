...
* [Download NLP-ADAPT image: You will be sent a link to download the image, NLP-IE.ova, from Google Drive (this will take about an hour over wifi).](#download-nlp-adapt-image-you-will-be-sent-a-link-to-download-the-image-nlp-ieova-from-google-drive-this-will-take-about-an-hour-over-wifi)
* [Share the files for analysis.](#share-the-files-for-analysis)
* [Please be aware](#please-be-aware)
* [Open the VM](#open-the-vm)
* [Using the Software](#using-the-software)
* [Click on the desktop shortcut for each annotator system. Please execute in the following order, proceeding to the next system, once each has finished running:](#click-on-the-desktop-shortcut-for-each-annotator-system-please-execute-in-the-following-order-proceeding-to-the-next-system-once-each-has-finished-running)
